    ...
    var body: some View {
        VStack(spacing: 0) {
            HStack {
                ...
                Text("MSG")       .frame(width: 48, alignment: .trailing)
                Text("OUTPUT")    .frame(width: 70, alignment: .trailing)
                Text("COST")      .frame(width: 72, alignment: .trailing)
                Text("WEB")       .frame(width: 36, alignment: .trailing)
                Text("AI LINES")  .frame(width: 68, alignment: .trailing)
                Text("% AI")      .frame(width: 48, alignment: .trailing)
            }
